...
<!--     생일 -->
  ...
  <body>
      ...
      <article class="container">
        ...
        <a href="/bbs/">
        <img class="img-responsive center-block" src="resources/main.gif" alt="Chania" width="400" height="70">
        </a>
    	    	<h1>회원가입 <small>Register</small></h1>
    	    	
     
        </div>
        <form role="form" class="form-horizontal" action="/bbs/join.member" method="POST">
        ...
        <div class="col-sm-6">
          <input class="form-control" id="pw" name="pass" type="password" placeholder="비밀번호">
...
<!--           </div> -->
        ...
        <div class="form-group">
          <div class="col-sm-12 text-center">
            ...
            <button class="btn btn-danger" type="button" onclick="document.location.href='/bbs/list.bbs?pageNum=1'">가입취소<i class="fa fa-times spaceLeft"></i></button>
          </div>
        </div>
        </form>
          <hr>
