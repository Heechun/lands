...
// 		var receiver=$(this).text();
		...
		$("form").attr("action","/bbs/send.message?receiver="+($(this).text())+"&pageNum="+pageNum);
...
<%@ include file="header.jsp" %>
	...
	<input type="hidden" id="pageNum2" value="${pageNum}">
...
<!-- 				ID가 있으면 클릭가능 아니면 안됌 -->
				<c:if test="${id!=null}">
					<td align="center" width="100"><a data-toggle="modal"
						data-target="#myModal" class="clickOnId">${article.id}</a></td>
				</c:if>
				<c:if test="${id==null }">
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<div class="modal-body">
							<textarea rows="20" cols="30" id="message" name="messageContent"></textarea>
						</div>
